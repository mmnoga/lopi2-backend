    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity http) throws Exception {
        http.csrf(AbstractHttpConfigurer::disable)
                ...
                .authorizeHttpRequests(request -> request
                        ...
                        .requestMatchers("/auth-reviews/**").hasAnyRole(SecurityRoles.ADMIN, SecurityRoles.USER)
                        .requestMatchers(HttpMethod.OPTIONS, "/admin-reviews/**").permitAll()
                        .requestMatchers("/admin-reviews/**").hasRole(SecurityRoles.ADMIN)
